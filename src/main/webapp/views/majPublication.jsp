...
<table>
<form action=majPublication method=post>
<tr><td>Nom </td> 
<td><input type=text name=titre value="${publication.titre }"></td></tr>
<tr><td>Auteur </td> 
<td><input type=text name=prenom value="${publication.auteur }"></td></tr>
<tr><td>Mail  </td>
